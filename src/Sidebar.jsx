...
function Profile() {
  return (
    <div className="bg-white border border-gray-100 dark:bg-gray-800 dark:border-gray-700 rounded-md shadow overflow-hidden h-max">
      <div className="h-32 bg-cover bg-[url('/cover-light.jpg')] dark:bg-[url('/cover-dark.jpg')]" />
      <div className="relative pt-14 p-5">
        <img className="dark:saturate-50 dark:brightness-90 w-20 h-20 border border-white dark:border-gray-600 rounded-md shadow absolute -top-10 left-5" src="/profile.jpg" />
